// src/pages/user/EnrolledCoursesPage.jsx - UPDATED
...
                    <CardTitle className="flex-grow text-foreground">{course.sdgNumber}. {course.title}</CardTitle>
...
          <h3 className="text-2xl font-semibold text-foreground">You're Not Enrolled in Any Courses Yet</h3>
